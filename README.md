...
### <a name="update_split_subscription"></a>![Method: ](https://apidocs.io/img/method.png "PagarmeCoreApi.PCL.Controllers.SubscriptionsController.UpdateSplitSubscription") UpdateSplitSubscription
